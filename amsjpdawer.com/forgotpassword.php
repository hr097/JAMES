                ...
                <div class="row w-100 mx-0">
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5 loginbox">
                            ...
                            <div id="requestotp"> 
                                <p class="text-center page-title unselectable form-header">Enter your registered email</p>
                            ...
                            <div id="enterotp">
                                <p class="text-center page-title unselectable form-header" style="font-size: 22px;">Enter OTP</p>
