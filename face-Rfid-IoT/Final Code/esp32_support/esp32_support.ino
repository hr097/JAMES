...
#include <WebServer.h> //library for intiating web server
#include <FS.h>   //library for using File System Headers
#include <SPIFFS.h>

const char* titleFile = "/title-icon.jpeg"; // title bar icon for webpage
...
WebServer server(80); // at port 80 all communication will be done
...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="title-icon.jpeg">
</head>
<style>
    * {
        margin: 0;
