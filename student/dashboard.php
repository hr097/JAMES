...
//@query
$sql = "select spid,SUBSTRING(name,INSTR(name,' '),( (LOCATE(' ',name,INSTR(name,' ')+1)) - INSTR(name,' ') )) AS fname,SUBSTRING(name,1 ,(     LOCATE(' ',name,INSTR(name,' ')+1)     ) ) AS fullname,gender from vw_students where email='$u';"; 
