...
<head>
    ...
    <!-- page information-->
    <title>Reset password | JPD AMS</title>
                ...
                <div class="row w-100 mx-0">
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5 loginbox">
                            ...
                            <h2 class="text-center page-title unselectable form-header">Reset password</h2>
                            <!-- Logo,Header and title : Start-->
                            ...
                            <form class="pt-3">
                                <div class="form-group">
                                    <input type="password" class="form-control form-control-lg fieldstyle" placeholder="Enter new password">
                                </div>
                                <div class="form-group">
                                    <input type="password" class="form-control form-control-lg fieldstyle" placeholder="Confirm password">
                                </div>
