              ...
              <div class='scene'>
                <div class='flip-card' >
                 ...
                 <div class='card__face card__face--front' style='border-radius: 10px;'>
                   ...
                   <h4  class='profile_name' style='color:white;margin-top:92px;' >".$record['name']."</h4>
                   <h4  class='profile_name' style='color:white;margin-top:10px;font-size:0.8em;' >[".$record['gender']."]</h4>
                 </div>
