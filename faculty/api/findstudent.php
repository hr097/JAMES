...
{ 
    $sql= "select Students.*,DATE_FORMAT(Students.dob,'%d-%m-%Y')AS dob from Students,Courses where Courses.course_id=Students.course_id and Courses.course_name='$course' and cur_semester=$cur_sem and cur_division='$div' and spid NOT IN(select spid from Ams_setup_students_map where ams_setup_id=$classroomid);";
