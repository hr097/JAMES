...
{ 
    $sql= "select Students.*,DATE_FORMAT(Students.dob,'%d-%m-%Y')AS dob from Students where spid like '$spid%' and NOT IN(select spid from Ams_setup_students_map where spid='$spid' and ams_setup_id=$classroomid);";
